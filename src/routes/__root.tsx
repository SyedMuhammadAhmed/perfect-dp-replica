...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "DP Studio — Perfect WhatsApp Profile Picture Tools" },
      { name: "description", content: "Free browser-based tools to resize, frame, crop, round and stylize your WhatsApp DP. No sign-up, no uploads, instant download." },
    ],
